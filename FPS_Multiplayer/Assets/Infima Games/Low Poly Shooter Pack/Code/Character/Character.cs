...
namespace Infima_Games.Low_Poly_Shooter_Pack.Code.Character
{
	...
	public sealed class Character : CharacterBehaviour
	{
		...
		[SerializeField]
		private UnityEngine.Camera cameraDepth;
		...
		/// GetCameraWorld.
		/// </summary>
		public override UnityEngine.Camera GetCameraWorld() => cameraWorld;
		/// <summary>
		/// GetCameraDepth.
		/// </summary>
		/// <returns></returns>
		public override UnityEngine.Camera GetCameraDepth() => cameraDepth;
