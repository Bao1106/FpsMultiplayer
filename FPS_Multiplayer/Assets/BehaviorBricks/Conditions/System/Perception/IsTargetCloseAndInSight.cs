...
namespace BBUnity.Conditions
{
    ...
    [Pada1.BBCore.Help("Checks whether a target is close and in sight depending on a given distance and an angle")]
    public class IsTargetCloseAndInSight : GOCondition
    {
        ///<value>Input Target Parameter to to check the distance and angle.</value>
        [InParam("target")]
        [Pada1.BBCore.Help("Target to check the distance and angle")]
        public GameObject target;

        ///<value>Input view angle parameter to consider that the target is in sight.value>
        [InParam("angle")]
        [Pada1.BBCore.Help("The view angle to consider that the target is in sight")]
        public float angle;

        ///<value>Input maximun distance Parameter to consider that the target is close.</value>
        [InParam("closeDistance")]
        [Pada1.BBCore.Help("The maximun distance to consider that the target is close")]
