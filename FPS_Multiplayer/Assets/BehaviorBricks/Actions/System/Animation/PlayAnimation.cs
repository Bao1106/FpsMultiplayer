...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Plays an animation in the game object")]
    public class PlayAnimation : GOAction
    {
        ...
        [Pada1.BBCore.Help("The clip that must be played")]
        ...
        [Pada1.BBCore.Help("Period of time to fade this animation in and fade other animations out")]
        public float crossFadeTime = 0.25f;

        ///<value>Wrapping mode of the animation.</value>
        [InParam("animationWrap")]
        [Pada1.BBCore.Help("Wrapping mode of the animation")]
        ...
        [Pada1.BBCore.Help("Wheter the action waits till the end of the animation to be completed")]
