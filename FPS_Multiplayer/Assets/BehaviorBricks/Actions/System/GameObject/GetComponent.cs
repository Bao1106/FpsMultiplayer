...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Gets the component of a given type if the game object has one attached, null if it doesn't")]
    public class GetComponent : GOAction
    {
        ///<value>Input Component type Parameter.</value>
        [InParam("type")]
        [Pada1.BBCore.Help("Component type")]
        public string type;

        ///<value>OutPut Found game object Parameter.</value>
        [OutParam("component")]
        [Pada1.BBCore.Help("Found component, null if the game object hasn't one attached")]
