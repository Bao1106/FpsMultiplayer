...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Rotates the transform so the forward vector of the game object points at target's current position")]
    public class LookAt : GOAction
    {
        ///<value>Input Target game object Parameter.</value>
        [InParam("target")]
        [Pada1.BBCore.Help("Target game object")]
