...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Destroys the gameobject")]
    public class Destroy : GOAction
    {
        ///<value>Input Game object to be destroyed Parameter.</value>
        [InParam("game object")]
        [Pada1.BBCore.Help("Game object to be destroyed, if no assigned the game object of this behavior will be destroyed")]
