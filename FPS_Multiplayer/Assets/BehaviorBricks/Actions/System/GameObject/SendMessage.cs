...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Calls the method named methodName on every MonoBehaviour in this game object")]
    public class SendMessage : GOAction
    {
        ///<value>Input Name of the method that must be called Parameter.</value>
        [InParam("methodName")]
        [Pada1.BBCore.Help("Name of the method that must be called")]
        public string methodName;

        ///<value>Input Game object to send the message Parameter.</value>
        [InParam("game object")]
        [Pada1.BBCore.Help("Game object to send the message, if no assigned the message will be sent to the game object of this behavior")]
