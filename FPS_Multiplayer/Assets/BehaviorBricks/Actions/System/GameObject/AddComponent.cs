...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Adds a component to the game object")]
    public class AddComponent : GOAction
    {
        ...
        [InParam("type")]
        [Pada1.BBCore.Help("Type of the component that must be added")]
        public string type;

        ///<value>Game object to add the component.</value>
        [InParam("game object")]
        [Pada1.BBCore.Help("Game object to add the component, if no assigned the component is added to the game object of this behavior")]
