...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Activates or deactivates the game object")]
    public class SetActive : GOAction
    {
        ///<value>Input bool Parameter.</value>
        [InParam("active")]
        [Pada1.BBCore.Help("true if must be activate")]
        public bool active;

        ///<value>Input Game object to set the active value Parameter.</value>
        [InParam("game object")]
        [Pada1.BBCore.Help("Game object to set the active value, if no assigned the active value will be set to the game object of this behavior")]
