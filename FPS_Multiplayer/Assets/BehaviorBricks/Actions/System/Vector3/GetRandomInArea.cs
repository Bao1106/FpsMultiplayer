...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Gets a random position from a given area")]
    public class GetRandomInArea : GOAction
    {
        ...
        [InParam("area")]
        [Pada1.BBCore.Help("GameObject that must have a BoxCollider or SphereColider, which will determine the area from which the position is extracted")]
        ...
        [Pada1.BBCore.Help("Position randomly taken from the area")]
