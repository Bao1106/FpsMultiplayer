...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Moves the game object to a given position by using a NavMeshAgent")]
    public class MoveToPosition : GOAction
    {
        ///<value>Input target position where the game object will be moved Parameter.</value>
        [InParam("target")]
        [Pada1.BBCore.Help("Target position where the game object will be moved")]
