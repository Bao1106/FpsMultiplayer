...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Plays an audio clip from the game object position")]
    public class PlaySound : GOAction
    {
        ...
        [InParam("volume")]
        [Pada1.BBCore.Help("Volume of the clip")]
        public float volume = 1f;

        ///<value>Wheter the action waits till the end of the clip to be completed.</value>
        [InParam("waitUntilFinish")]
        [Pada1.BBCore.Help("Wheter the action waits till the end of the clip to be completed")]
