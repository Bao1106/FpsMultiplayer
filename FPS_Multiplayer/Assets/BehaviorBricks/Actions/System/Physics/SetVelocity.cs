...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Sets a velocity to the game object. As a result the game object will start moving")]
    public class SetVelocity : GOAction
    {
        ///<value>Input Game object where the velocity is set Parameter.</value>
        [InParam("toSetVelocity")]
        [Pada1.BBCore.Help("Game object where the velocity is set, if no assigned the velocity is set to the game object of this behavior")]
        public GameObject toSetVelocity;

        ///<value>Input Velocity Parameter.</value>
        [InParam("velocity")]
        [Pada1.BBCore.Help("Velocity")]
