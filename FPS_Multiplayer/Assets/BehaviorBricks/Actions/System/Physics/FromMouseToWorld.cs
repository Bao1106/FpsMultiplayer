...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Gets the game object and position that is under the mouse cursor")]
    public class FromMouseToWorld : GOAction
    {
        ...
        [Pada1.BBCore.Help("Game object under the mouse cursor")]
        public GameObject selectedGameObject;

        ///<value>OutPut Position under the mouse cursor Parameter.</value>
        [OutParam("selectedPosition")]
        [Pada1.BBCore.Help("Position under the mouse cursor")]
        public Vector3 selectedPosition;

        ///<value>Input Camera Parameter that is currently used to rendering the scene.</value>
        [InParam("camera")]
        [Pada1.BBCore.Help("Camera that is currently used to rendering the scene. If not assigned Camera.main is used")]
        ...
        [InParam("mask")]
        [Pada1.BBCore.Help("LayerMask with layers that must be considered relevant to calculate the game object and position under the mouse cursor")]
