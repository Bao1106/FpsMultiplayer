...
namespace BBUnity.Actions
{
    ...
    [Pada1.BBCore.Help("Adds a force to the game object. As a result the game object will start moving")]
    public class ApplyForce : GOAction
    {
        ///<value>Input Game object where the force is applied Parameter.</value>
        [InParam("toApplyForce")]
        [Pada1.BBCore.Help("Game object where the force is applied, if no assigned the force is applied to the game object of this behavior")]
        public GameObject toApplyForce;

        ///<value>Input Force to be applied Parameter.</value>
        [InParam("force")]
        [Pada1.BBCore.Help("Force to be applied")]
